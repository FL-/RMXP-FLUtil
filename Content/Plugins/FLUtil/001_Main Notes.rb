#===============================================================================
# * FLUtils - by FL (Credits will be apreciated)
#===============================================================================
#
...
# - Variable Switches Alias, who makes switch/variable access shorter and more
# readable
# - Tween system
...
# The files are:
#
# - 001_Main Notes.rb - This file, only with instructions
...
# - 008_Test.rb - Used to me to quickly test stuff, so requires all other
# files, except 005_Tweener.rb.
#
# All files works without Essentials, some in very limited way. 
#
# To update this script to a newer version, replaces all files except
# 004_MyAlias.rb.
#
#===============================================================================